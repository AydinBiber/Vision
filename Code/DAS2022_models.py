...
from octopytorch.models import Tiramisu # cf: https://github.com/npielawski/octopytorch
from torchvision.models.densenet import _DenseLayer


UNET = Tiramisu(1,1, structure=([4], 4, [4]), checkpoint=False)
...
class Shallow(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d):
        ...
        model += [nn.ConvTranspose2d(ngf * 2, ngf, kernel_size=3, stride=2, padding=1, output_padding=1, bias=use_bias),
